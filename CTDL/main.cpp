	...
	while(1){
		...
		if (ismouseclick(WM_LBUTTONDOWN)){
			...
			if(x >= 301 && x <= 600 && y >= 1 && y <= 40){
				...
				textLine(5, 150, 165, 3, "LoaiHD: X");
				textLine(160, 460, 165, 3, "Ngay lap: dd/mm/yyyy");
				textLine(470, 640, 165, 3, "MaNV: e0001");
				textLine(650, 950, 165, 3, "$: 111111111111111111");
				
				textBox(1, 200, 200, 235, 15, 3, "Ma vat tu");
				textBox(200, 400, 200, 235, 15, 3, "So luong");
				textBox(400, 600, 200, 235, 15, 3, "Don gia");
				textBox(600, 800, 200, 235, 15, 3, "VAT(%)");
				
				for (int i = 0; i < 10; ++i){
					textBox(1, 200, 235 + i * 35, 270 + i * 35, 15, 3, "Ma vat tu");
					textBox(200, 400, 235 + i * 35, 270 + i * 35, 15, 3, "So luong");
					textBox(400, 600, 235 + i * 35, 270 + i * 35, 15, 3, "Don gia");
					textBox(600, 800, 235 + i * 35, 270 + i * 35, 15, 3, "VAT(%)");
				}
			}
		}
	}
